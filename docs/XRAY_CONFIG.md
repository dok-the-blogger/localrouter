...
3.  **Российские государственные и финансовые сервисы**
    *   **Правило:** `domain: sberbank.ru`, `domain: gosuslugi.ru` и др. -> `direct`
    *   **Приоритет:** 3-е место (сразу после локального трафика).
    *   **Описание:** Многие российские банки и гос. сервисы блокируют доступ с датацентровых IP (включая Selectel). Этот трафик должен маршрутизироваться напрямую в обход прокси.

4.  **Специальные маршруты (Meta/Facebook/Instagram)**
